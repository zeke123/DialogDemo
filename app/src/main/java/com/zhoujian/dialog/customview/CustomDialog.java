package com.zhoujian.dialog.customview;
...
import com.zhoujian.dialog.utils.ScreenSizeUtils;
import com.zhoujian.dialog.utils.UiUtils;
...
public class CustomDialog {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (mBuilder.getOnItemListener() != null) {
                    ...
                    mBuilder.getOnItemListener().onItemClick(CustomDialog.this, button,
                            clickPosition);
    ...
    public CustomDialog setDatas(List<String> datas) {
...
//
    ...
    public static class Builder {
        ...
        //item属性
        private DialogInterface.OnItemClickListener<CustomDialog> onItemListener;
        ...
        public DialogInterface.OnItemClickListener<CustomDialog> getOnItemListener() {
            return onItemListener;
        }

        public Builder setOnItemListener(DialogInterface.OnItemClickListener<CustomDialog> onItemListener) {
